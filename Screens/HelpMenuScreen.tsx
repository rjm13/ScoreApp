...
import { View, Text, StyleSheet, TouchableWithoutFeedback, Dimensions, Linking } from 'react-native';
        ...
        <View>
            ...
            <View style={{marginTop: 20}}>
                ...
                <TouchableWithoutFeedback onPress={() => Linking.openURL('mailto:martianspidermedia@gmail.com') }>
                    <View style={{width: SCREEN_WIDTH, marginHorizontal: 30, marginVertical: 20}}>  
